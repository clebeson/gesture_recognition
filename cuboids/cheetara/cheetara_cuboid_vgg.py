...
#1990038625666a7bd4371b1a3c37cc152494e921d6512130
...
class inception_cuboid:
    ...
    def maxpool(self, tensor, k=2):
        if len(tensor.shape) == 5:
            ...
            return tf.nn.max_pool3d(tensor, ksize=[1,  k,k, k, 1], strides=[1, k, k, k, 1], data_format= "NDHWC" , padding='VALID')
    ...
    def conv(self,x, kernel_size, depth):
